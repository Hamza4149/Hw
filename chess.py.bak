...
pieces_image = pygame.image.load('Chess_Pieces_Sprite.png').convert_alpha()
circle_image_green = pygame.image.load('green_circle_small.png').convert_alpha()
circle_image_capture = pygame.image.load('green_circle_neg.png').convert_alpha()
circle_image_red = pygame.image.load('red_circle_big.png').convert_alpha()
greenbox_image = pygame.image.load('green_box.png').convert_alpha()
circle_image_yellow = pygame.image.load('yellow_circle_big.png').convert_alpha()
circle_image_green_big = pygame.image.load('green_circle_big.png').convert_alpha()
yellowbox_image = pygame.image.load('yellow_box.png').convert_alpha()
#Menu pictures:
withfriend_pic = pygame.image.load('withfriend.png').convert_alpha()
withAI_pic = pygame.image.load('Media\\withAI.png').convert_alpha()
playwhite_pic = pygame.image.load('playWhite.png').convert_alpha()
playblack_pic = pygame.image.load('playBlack.png').convert_alpha()
flipEnabled_pic = pygame.image.load('flipEnabled.png').convert_alpha()
flipDisabled_pic = pygame.image.load('flipDisabled.png').convert_alpha()
